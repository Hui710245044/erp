...
export default {
    ...
    '/task': { ///base/task
        component: Vue.component('base-task', function (resolve) {
            require(['../view/base/task/index.vue'], resolve);
        })
    },
    '/channel': { //平台管理
    ...
    '/Publish/EbayListing/listingManagement': {
    ...
    '/report/publish-by-pinking': {//统计刊登下架spu列表
    ...
    //         require(['../view/entrepot/parcel-abnormalities2/index.vue'],resolve)
    //     })
    // },
    '/package-return': {
