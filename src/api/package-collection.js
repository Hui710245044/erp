...
export const api_batch_collection = function (data) {
    return http(Url2(url_batch_collection), data)
};
...
export const api_batch_delete = function (data) {
    return http(Url2(url_batch_delete), data)
};
