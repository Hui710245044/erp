...
//标记为已处理
export const url_batch_processing = "post|pickings-exception/batch-processing";
export const api_batch_processing = function (data) {
    return http(url_batch_processing, data);
};
//等待生成拣货单SKU列表
