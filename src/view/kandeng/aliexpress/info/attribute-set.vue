    ...
    <el-row class="p-attribute-set-wish">
        ...
        <div class="p-titleColour-attribute">
            ...
            <el-form ref="form1" label-width="80px" class="mt-sm">
                <el-form-item>
                    <el-checkbox v-model="tableData.quote_config_status">区域调价</el-checkbox>&nbsp;&nbsp;
                    <span v-if="tableData.quote_config_status">商品零售价作为基准价，开放部分“Ship to”区域，可在基准价基础上调整。</span>
...
<script>
    import {api_aliexpress_sku_listing,api_ref_price} from "../../../../api/publish-smt"
