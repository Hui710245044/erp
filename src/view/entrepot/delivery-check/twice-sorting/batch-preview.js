...
export const print = function (bool, flag) {
    ...
    let num = 1;
    // console.log('templateData', this.templateData, this.printData, this.templateGuide, this.templateLabel);
        ...
        if (row.type === 1) {
            if (row.isCombination) {
                ...
                row.value.length && row.value.forEach(item => {
                    // console.log('item', item , this.printData[item.value]);
                    switch (item.value) {
                        case -1:
                        case -2:
                        case -3:
                        ...
                        default:
                            if (!!this.printData[item.value]) {
                                if (this.printData[item.value]) {
                                    if (item.checked) {
                                        // console.info('combian', item.label, item.value, this.printData[item.value]);
