<template>
    <page-dialog title="添加" v-model="show" size="small" @open="open" @close="cloce" :close-on-cilck-modal="false">
        <el-form :model="form"
                 ref="form"
                 label-width="190px"
                 :rules="rules">
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            cloce(){
                this.show=false;
                this.form.submit_attribute_value = '';
                this.form.submit_attribute_name = '';
                this.form.password_attribute_value= '';
                this.form.password_attribute_name = '';
                this.form.username_attribute_value ='';
                this.form.username_attribute_name = '';
