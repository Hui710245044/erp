<template>
    <div class="after-marker">
      ...
      <evaluate :formData="formData" :has-shipping-time="hasShippingTime" :order_id="order_id" :orders-number="ordersNumber" :channel_name="channel_name" :mdfid="mdfid" @review="review"></evaluate>
          ...
          <td class="t-left">
            <div v-if="!isShow && form.customer && form.customer.address &&!form.customer.address.recipient">
              ...
              <permission
                ...
                size="mini"
                type="primary"
                @click.native="edit_address">编辑</permission>
            </div>
                ...
                <el-row class="mb-sm">
                  ...
                  <el-col :span="8">
                    <el-form-item label="邮编：">
                      <ui-input :edit="isEdit" type="number" v-model="address.zip_code" @input="change_english"></ui-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row class="mb-sm">
                  ...
                  <el-col :span="8">
                    <el-form-item label="国家：">
                      <el-select v-if="isEdit" v-model="address.country_code" ref="country" v-mouse-side.mousewheel="()=>{$refs.country.visible=false}" filterable clearable >
                        <el-option v-for="(item, index) in countryList" :key="index" :value="item.value" :label="item.label"></el-option>
                      </el-select>
            ...
            <div v-if="form.customer">
              <div v-if="form.customer.is_generate">
                ...
                <permission
                  ...
                  @click="create_click"
                  title="点击重新生成发票">重新生成</permission>
              ...
              <div v-else>
                ...
                <permission
                  ...
                  class="ml-sm operate"
                  :route="apis.url_get_generate"
                  @click="create_click" title="点击手动生成发票">手动生成</permission>
    ...
    export default{
        ...
        computed:{
            ...
            hasShippingTime(){
                ...
                let time = Math.abs(outTime-nowTime);
                let loseTime = Math.floor((time/(3600*1000*24*30)));
                return  this.isInvalid || loseTime>1&&this.form.shipping_time!=0
            }
        },
        filters:{
            filterPrice(val){
