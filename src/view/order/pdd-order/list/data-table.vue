        ...
        <ui-table v-loading="loading"
            ...
            <template v-for="(data, index) in dataTable">
                <tr class="line" :class="[data.show ? 'active' : '',data.clickData?'active-color':'']"
                    ...
                    <!--付款日期-->
                    <td>
                        <ui-tip :content="data.create_at|timeFilter" :width="88"></ui-tip>
                    </td>
                    <!--平台发货状态-->
                    <td>
                    ...
                    <!--下单时间-->
                    <td>
                        <ui-tip :content="data.create_at|dateFilter" :width="88"></ui-tip>
                    </td>
                    <!--最迟发货时间-->
                    <td>
...
<script>
    ...
    import {api_order_pdd_check} from '../../../../api/order-pdd';
    import {url_api_order_pdd_check} from '../../../../api/order-pdd';
