            ...
            <tabs>
                <tab-head :navs="[{label:'订单基本信息',action:''},{label:'产品信息',action:'product'},{label:'收货人信息',action:'buyinfo'}]">
                    ...
                    <el-row>
                        ...
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">付款时间</span>: <span class="detail">{{checkList.create_at | dateFilter}}</span>
                            </div>
                        </el-col>
                    </el-row>
                    <el-row>
                    ...
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">发货时间</span>: <span class="detail">{{checkList.last_ship_time|dateFilter}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
