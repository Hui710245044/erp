<template>
    <el-row class="wish-order-form">
        <page-dialog :title="`查看订单：${this.checkList.deliverynumber} 信息`" v-model="orderDialog" :size="dialogSize" :close-on-click-modal="false">
            <!--    cardControl     -->
            <tabs>
                    ...
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">订单号</span>: <span class="detail">{{checkList.deliverynumber}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">订单生成时间</span>: <span class="detail">{{checkList.ordertime|dateFilter}}</span>
                            </div>
                        </el-col>
                    </el-row>
                    <el-row>
                        ...
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">订单状态</span>: <span class="detail">{{checkList.orderstatus | statusFilter}}</span>
                            </div>
                        </el-col>
                    </el-row>
                    <el-row>
                        ...
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">付款时间</span>: <span class="detail">{{checkList.ordertime | dateFilter}}</span>
                            </div>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">出售价</span>: <span class="detail">{{checkList.totalamount}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">运费</span>: <span class="detail">{{checkList.shippingfee}}</span>
                            </div>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">支付总额</span>: <span class="detail">{{checkList.totalamount}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
                        ...
                        <el-table-column label="产品图片"  align="center" width="100" inline-template>
                            <div>
                                <el-popover
                                    ...
                                    placement="right"
                                    trigger="hover">
                                    <img v-lazy="sku_image(row.imageurl)" width="200px" height="200px">
                                </el-popover>
                                <img v-popover:popover  class="wish-img" v-lazy="row.imageurl" width="60px" height="60px">
                            </div>
                        </el-table-column>
