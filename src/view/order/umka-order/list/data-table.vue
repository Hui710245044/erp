            ...
            <template v-for="(data, index) in dataTable">
                <tr class="line" :class="[data.show ? 'active' : '',data.clickData?'active-color':'']"
                    ...
                    <td class="t-left" nowrap="nowrap">
                        ...
                        <ui-tip :content="data.deliverynumber" :width="68" v-copy></ui-tip>
                    </td>
                    <!--账号简称-->
                    <td>
                    ...
                    <!--运费-->
                    <td>
                        <ui-tip :content="data.shippingfee" :width="88"></ui-tip>
                    </td>
                    <!--出售价-->
                    <td>
                    ...
                    <!--支付总额-->
                    <td>
                        <ui-tip :content="data.totalamount" :width="88"></ui-tip>
                    </td>
                    <!--付款日期-->
                    <td>
                        <ui-tip :content="data.ordertime|timeFilter" :width="88"></ui-tip>
                    </td>
                    <!--平台发货状态-->
                    <td>
                    ...
                    <!--订单状态-->
                    <td>
                        <ui-tip :content="data.orderstatus | statusFilter" :width="88"></ui-tip>
                    </td>
                    <!--追踪单号-->
                    <td>
                        <ui-tip :content="data.trackingnumber" :width="88"></ui-tip>
                    </td>
                    <!--下单时间-->
                    <td>
                        <ui-tip :content="data.ordertime|dateFilter" :width="88"></ui-tip>
                    </td>
                    <!--最迟发货时间-->
                    <td>
                    </td>
