...
//                                console.log(val2,val2.attribute_id,'val2.attribute_id');
//                                console.log(val1,val1.attribute_id,'val1.attribute_id');
...
//                                let val2 = enabledData[i-1].attributes[j];
//                                let val1 = enabledData[i].attributes[j];
//                                console.log(val2,val2.attribute_id,'val2.attribute_id-i-1>0');
//                                console.log(val1,val1.attribute_id,'val1.attribute_id-i-1>0');
//                                if(val2.attribute_id===val1.attribute_id&&val2.attribute_value===val1.attribute_value){
//                                    isTrue.push(true);
//                                }else{
//                                    isTrue.push(false);
...
//                console.log(this.specData,'this.specData');
                ...
                this.$http(publish_skuinfo_keep,this.goodsId,{lists:mdfData}).then(res=>{
                    ...
                    this.tempSku=clone(this.lookspecData);
                    this.show.splice(2,1,false);
                }).catch(code=>{
                    this.$message({type:'error',message:code.message||code});
                }).finally(()=>{
