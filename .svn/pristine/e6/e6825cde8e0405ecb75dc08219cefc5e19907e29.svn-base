...
<script>
    ...
    export default {
        ...
        mounted() {
            this.channels();
            this.init();
            this.warehouseList = this.$refs.warehouse.warehouses;
        ...
        methods: {
            ...
            select_channel(index) {
                this.shipping_id = 0;
                this.form.channel_id = this.buttonsChannel[index].value;
        ...
        watch: {
            ...
            'warehouse_id'() {
                let warehouseList = this.$refs.warehouse.warehouses;
                console.log(warehouseList);
                if (warehouseList.length > 0) {
                    let warehouse = warehouseList.find(row => row.value === this.warehouse_id);
