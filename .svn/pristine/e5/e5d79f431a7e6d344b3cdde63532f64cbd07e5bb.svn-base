        ...
        <el-col>
            <ui-table v-model="checkAll" class="manager"
                      ...
                      :heads="[
                        ...
                        {label:'产品图片',width:6},
                        {label:'SPU',width:7},
                        {label:'中英文报关名',width:9},
                        {label:'产品中文名称',width:13},
                        {label:'分类',width:10},
                        {label:'物流属性',width:6},
                        {label:'海关编码',width:7},
                        {label:'开发员',width:6},
...
<script>
    import {publish_status, publish_sku, api_change_sku_status,api_get_label,api_batch_delete,
        url_batch_delete,url_publish_updata_baseinfo,url_change_sku_status} from  "../../../api/product-library"
    ...
    export default{
        permission:{
            url_publish_updata_baseinfo,url_change_sku_status,url_batch_delete
        },
        filters: {
            filterPrice(val){
