<template>
    <div class="c-data-list relative">
        <color-tip></color-tip>
        <el-table
            class="scroll-bar"
        ...
        >
            ...
            <el-table-column label="买家ID" inline-template v-if="clientWidth">
                <div>
            ...
            <el-table-column label="付款状态" inline-template>
                <div>
                    <times v-if="row.pay_status" :time="row.pay_status"></times>
                    <label v-else>未付款</label>
                </div>
            </el-table-column>
            <el-table-column label="交易号" inline-template>
                <div>
                    <ui-tip :content="row.transaction_id" :width="98"></ui-tip>
                </div>
            </el-table-column>
            <el-table-column label="支付总额" show-overflow-tooltip inline-template>
            ...
            <el-table-column label="跟踪单号" inline-template :width="118">
                <div>
                    <ui-tip :content="row.shipping_number" :width="98"></ui-tip>
                </div>
            </el-table-column>
            <el-table-column label="下单时间" inline-template>
