                        ...
                        <div>
                            ...
                            <div v-if="!!detail.id" style="height:26px">
                                ...
                                <permission tag="ElButton"
                                            ...
                                            type="primary" class="fr">删除</permission>
                            </div>
                            <div class="max-heigh">
                                <iframe style="width:100%;min-height:900px;height:100%" scrolling="yes" :srcdoc="detail.text"></iframe>

                            </div>
                            <div class="inline" v-if="detail.media&&detail.media.length>0"  v-for="img in detail.media" :key="img.MediaURL" style="margin-top:5px">
                                <el-popover
                                        placement="bottom-start"
                                        trigger="hover">
                                    <img :src="img.MediaURL" width="300px" height="400px" >
                                    <span slot="reference">
                                         <img :src="img.MediaURL" width="50px" height="26px"  style="cursor: -webkit-zoom-in;">
                                </span>
                                </el-popover>
                            </div>
                        </div>
...
<script>
    ...
    import {api_out_list,api_ebay_message_detail,api_message_table_list,api_message_resend,api_ebay_message_del,api_message_resend_batch} from "../../../../api/inbox"
      ...
      refresh(){
        ...
        methods:{
            ...
            look_detail(message){
                ...
                this.tableData=[];
                this.$http(api_message_table_list,{id:message.id,message_id:message.message_id,msg_type:3}).then(res=>{
            ...
            resend(){
                return this.$http(api_message_resend,{id:this.detail.id,message_id:this.detail.message_id}).then(res=>{
                    this.$message({
                        type:"success",
                        message: '发送成功'
                    });
