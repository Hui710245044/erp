...
<script>
    ...
    import {url_post_dispute,url_accept_cancel_order,url_reject_cancel_order,api_post_dispute,api_get_seller_reason,api_get_shopee_log,api_accept_cancel_order,api_reject_cancel_order} from '../../../../api/dispute';
    export default {
        name: "shopee-dispute",
        permission:{
            url_add_order,
        ...
        methods:{
            //新建售后单
            new_add(){
                this.disputeParams.dispute_id = this.disputeData.id;
            ...
            //获取纠纷日志
            get_dispute_log(){
                this.$http(api_get_shopee_log, this.disputeData.returnsn).then(res => {
                    this.disputeLog = res
                }).catch(code => {
