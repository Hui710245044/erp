<template>
        <page class="p-index">
            ...
            <el-card>
                <label-item label="扫描/录入拣货单号或者周转箱号开始包装作业：" class="mt-lg mb-lg">
                    ...
                    <div v-if="message">
                        <span class="message red"><i class="el-icon-circle-close inline" style="font-size:25px;color:red;margin: 0 5px 6px;" ></i>{{message}}</span>
                    </div>
                </label-item>
            </el-card>
            <div class="box mt-xs">
    ...
    <script>
        import {api_single_box,api_pickings_packing} from '../../../../api/delivery-check';
