    ...
    <page class="p-index p-index-supplier-quote" style="position: relative">
        <search-card @search="search" :params="searchParams" :clears="clears">
            <div>
                ...
                <el-select class="ml-sm s-width-small inline" v-model="searchParams.date_s" v-sf.create_time>
        ...
        <goods-classify ref="classifyPart" :leftControllerTitle="leftControllerTitle">
            ...
            <el-table class="mt-xs scroll-bar aleady-table"
                ...
                <el-table-column label="SKU/别名" min-width="80" inline-template>
                    <div>
                        <div>{{row.sku}}</div>
                ...
                <el-table-column label="供应商" min-width="100" inline-template row-key="company_name">
                    <div v-if="row.company_name">
                ...
                <el-table-column label="区间报价" align="center" inline-template min-width="120">
                ...
                <el-table-column label="创建时间" inline-template min-width="70">
                    <div>
