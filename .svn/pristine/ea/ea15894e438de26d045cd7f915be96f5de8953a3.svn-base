<template>
    <el-row class="c-btnlist-middle">
        <label-items label="">
            ...
            <!--<permission tag="requestButton"-->
                        <!--@click="shopee_export"-->
                        <!--req-key="shopeeExport"-->
                        <!--:route="apis.url_download_shopee">Shopee格式导出</permission>-->
            <!--<permission tag="requestButton"-->
                        <!--@click="cdiscount_export"-->
                        <!--req-key="cdiscountExport"-->
                        <!--:route="apis.url_download_discount">Cdiscount格式导出</permission>-->
            <!--<permission tag="requestButton"-->
                        <!--@click="walmart_export"-->
                        <!--req-key="walmartExport"-->
                        <!--:route="apis.url_download_walmart">walmart格式导出</permission>-->
            <!--<permission tag="requestButton"-->
                        <!--@click="lazada_export"-->
                        <!--req-key="lazadaExport"-->
                        <!--:route="apis.url_download_lazada">lazada格式导出</permission>-->
            <permission tag="requestButton"
                        :route="apis.url_get_phash"
                        req-key="repetition"
                        @click.native="check_repetition">图片查重</permission>
            <check-repetition v-model="repetitionDialog" @confirm-repetition="confirm_repetition"></check-repetition>
...
<script>
    ...
    import{url_publish_add_baseinfo,url_update_excel,url_goods_import_update,
        ...
        url_push_irobotbox,url_download_shopee,url_export_sku,
...
//            shopee_export(){
//                this.$emit('shopee-export');
//            },
//            cdiscount_export(){
//                this.$emit('cdiscount-export');
//            },
//            walmart_export(){
//                this.$emit('walmart-export');
//            },
//            lazada_export(){
//                this.$emit('lazada-export');
//            },
