<template>
    <div class="mt-sm mb-sm">
        ...
        <el-button type="primary" size="mini" @click="open_time_up_lower">开启定时上下架</el-button>
        <el-button type="primary" size="mini" @click="close_time_up_lower">关闭定时上下架</el-button>
        ...
        <page-dialog title="开启定时上下架规则" v-model="upLowRuleVisible" size="large" :close-on-click-modal="false" @open="open">
            <label-item label="规则名称：" class="ml-sm mr-sm">
                <el-input v-model="searchData.rule_name" class="s-width-middle" @keyup.native.enter="search_rule"></el-input>
            </label-item>
            <el-button type="primary" size="mini" class="inline" @click.native="search_rule">搜索</el-button>
            <el-table
                ...
                <el-table-column width="50">
                    <template slot-scope="scope">
                        <el-radio v-model="ruleRadio" :label="scope.row.id" @change.native="getRuleRow(scope.$index,scope.row.id)">&nbsp</el-radio>
                    </template>
                </el-table-column>
                ...
                <el-table-column type="expand">
                    <template slot-scope="props">
                        <table class="template">
                            <tr style="background-color: #f8ffc4">
                                <td colspan="2">
                                    <el-checkbox v-model="props.row.monday_up_lower.is_check" disabled>星期一</el-checkbox>
                                </td>
                                <td colspan="2">
                                    <el-checkbox v-model="props.row.tuesday_up_lower.is_check" disabled>星期二</el-checkbox>
                                </td>
                                <td colspan="2">
                                    <el-checkbox v-model="props.row.wednesday_up_lower.is_check" disabled>星期三</el-checkbox>
                                </td>
                                <td colspan="2">
                                    <el-checkbox v-model="props.row.thursday_up_lower.is_check" disabled>星期四</el-checkbox>
                                </td>
                                <td colspan="2">
                                    <el-checkbox v-model="props.row.friday_up_lower.is_check" disabled>星期五</el-checkbox>
                                </td>
                                <td colspan="2">
                                    <el-checkbox v-model="props.row.saturday_up_lower.is_check" disabled>星期六</el-checkbox>
                                </td>
                                <td colspan="2">
                                    <el-checkbox v-model="props.row.sunday_up_lower.is_check" disabled>星期天</el-checkbox>
                                </td>
                            </tr>
                            <tr style="background-color: #f8ffc4">
                                <td>上架时间</td>
                            ...
                            <tr v-for="(item, index) in props.row.monday_up_lower.up_lower_tme" :key="index" style="background-color: #f8ffc4">
            ...
            <div style="text-align: right; margin-top: 10px;">
                <el-button type="primary" size="mini" @click="open_rule_affirm">确认</el-button>
                <el-button size="mini" @click="upLowRuleVisible = false">取消</el-button>
            </div>
            <el-pagination
                    class="page-fixed"
