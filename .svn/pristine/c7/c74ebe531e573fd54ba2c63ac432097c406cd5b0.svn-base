    ...
    <div>
            ...
            <div style="position: relative">
                <drag-drop tag="ul" class="image-thums im" v-model="imgs">
                    <li :style="imageStyle"
                        ...
                        <div v-if="index===0" class="mian-pic" title="主图"></div>
                        ...
                        <div class="tool">
                            ...
                            <span class="btn-img el-icon-search" title="查找" @click="search_img(image.path)"></span>
                        </div>
        ...
        <div>
            ...
            <el-button type="primary"
                       size="mini"
                       v-if="showRandomBtn"
                       @click="random_arr">随机排序
            </el-button>
            <el-button type="primary"
                       v-if="needClearAll"
                       size="mini"
                       @click.native="clear_all">清空所有
            </el-button>
            <el-button type="primary"
                       size="mini"
                       v-if="generateImage"
                       @click.native="generate_image">生成图片</el-button>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            clear_all() {
                this.$confirm(`您将删除当前所有图片，确认此操作吗？`, '提示', {
            ...
            meitu(index, image) {
                this.meituUrl = this.baseUrl+image.path;
                console.log(this.meituUrl,'this.meituUrl');
                this.curIndex = index;
                this.showMeitu = true;
            },
            saveBase64(base64, fileName) {
                const goods_id = Number(this.id[0]);
