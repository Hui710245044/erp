        ...
        <el-card ref="tableCard"
            ...
            <el-table
                ...
                <el-table-column
                    ...
                    min-width="60">
                    <div>
                        <ui-tip :width="98" :content="row.buyer"></ui-tip>
                    </div>
                </el-table-column>
                <el-table-column
                        inline-template
...
<script>
    ...
    import {api_fba_orders_list, api_fba_orders_detail, api_fba_orders_report, api_account_list, api_fba_chart_data,api_fba_export,api_fba_field} from '../../../api/fba-orders';
    import {
    ...
    export default {
        ...
        methods: {
            ...
            order_export(params, head) {
                return this.$http(api_fba_export, params, head).then(res => {
                    if (res.join_queue === 1) {
