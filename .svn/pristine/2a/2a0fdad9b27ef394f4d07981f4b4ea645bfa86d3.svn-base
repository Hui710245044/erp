<template>
    <div class="c-table-data">
        <div class="relative ml-sm mb-sm">
...
<script>
    import {url_package,url_providers_exception_batch_running_declare,api_providers_exception_batch_running_declare,url_providers_exception_export,api_providers_exception_export} from "../../../../api/shipment"
